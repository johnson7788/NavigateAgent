...
from tools import generate_ppt_tool
...
class NaviAgent(LlmAgent):
    ...
    def _get_dynamic_instruction(self, ctx: InvocationContext) -> str:
        ...
        prompt_instruction = prompt.QA_prompt.format(user_question=user_input)
            
        return prompt_instruction

root_agent = NaviAgent()
